...
import imageBottom from './images/bg-pattern-bottom-desktop.svg'
      ...
      <section>
        <div className='header'>
          ...
          <div className='mainStarContainer'>
            ...
            <div className='reviewContainer b'>
                <div className='starsContainer'>
                  <img src={stars} alt='stars' />
                  <img src={stars} alt='stars' />
                  <img src={stars} alt='stars' />
            ...
            <div className='reviewContainer c'>
                <div className='starsContainer'>
                  <img src={stars} alt='stars' />
                  <img src={stars} alt='stars' />
                  <img src={stars} alt='stars' />
        ...
        <img className='backgroundBottom' src={imageBottom} alt='backgroung bottom' />
